...
<CardGroup cols={2}>
  ...
  <Card title="Configuration" icon="gear" href="/configuration/ai-models">
    Configure RAG parameters
  </Card>
  <Card title="Memory System" icon="database" href="/advanced/memory-system">
    Complement RAG with episodic memory
  </Card>
  <Card title="RAG System" icon="brain" href="/concepts/rag-system">
